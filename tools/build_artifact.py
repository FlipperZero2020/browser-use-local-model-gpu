...
<div class="shell">
  ...
  <main>
    <div class="eyebrow">Design doc &amp; status log &middot; 2026-09-01</div>
    <div class="strip">
      <div class="strip-h">Measured live at time of writing &mdash; 192.168.1.111</div>
      <div class="strip-g">
        <div class="cell"><span class="k">warden</span><span class="v ok">ok &middot; idle</span></div>
        <div class="cell"><span class="k">book available</span><span class="v">12489 MiB</span></div>
        <div class="cell"><span class="k">max peak</span><span class="v">11353 MiB</span></div>
        <div class="cell"><span class="k">ollama</span><span class="v">0.32.15</span></div>
        <div class="cell"><span class="k">resident</span><span class="v">none</span></div>
        <div class="cell"><span class="k">browser-use</span><span class="v">0.13.8</span></div>
        <div class="cell"><span class="k">vision models</span><span class="v">0</span></div>
      </div>
    </div>
